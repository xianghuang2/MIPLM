...
class DataTrainingArguments:
    ...
    ex_file: Optional[str] = field(default=None,
                                   metadata={"help": "The ex data file (a text file)."})
    miss_column: Optional[list[str]] = field(
        default=None,
        metadata={"help": "An optional missing column."},
    )
    decoder_column: Optional[list[str]] = field(
        default=None,
        metadata={"help": "An optional decoder column."}
    )
...
class TrainingArguments:
    ...
    annoy_k: int = field(default=5, metadata={"help":"Get K-neighbors from Annoy."})
    ...
    num_train_epochs: float = field(default=50, metadata={"help": "Total number of training epochs to perform."})
